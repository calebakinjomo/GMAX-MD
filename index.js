const {
  ...
  const ownerNumber = ['2348130916634']
...
if(!config.SESSION_ID) return console.log('Please add your Gmax session to SESSION_ID env !!')
...
const port = process.env.PORT || 9090;
 ...
 conn.ev.on('creds.update', saveCreds)  
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('2348130916634', '255622053093', '255753853473');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("255622053093")){
  if(isReact) return
  m.react("🧑‍💻")
   }
  //==========public react============//
